...
- 🛠 Tech Stack: `React` | `Next.js` | `TailwindCSS` | `Figma`  

## 🚀 Projects & Work
- 🔗 [E-commerce App](https://yourproject.com) - A modern e-commerce platform with **React & Laravel**  
- 📌 [Job Finder](https://yourproject.com) - A job-hunting website built with **Spring Boot**  -->
...
<!--
**NgocHoang17/NgocHoang17** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
